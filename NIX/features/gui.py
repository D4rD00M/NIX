...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("NIX 2.0")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("NIX/utils/images/miguel.gif"))
...
"font: 75 18pt \"MS Shell Dlg 2\";")
        ...
        self.label_2.setPixmap(QtGui.QPixmap("NIX/utils/images/INT.gif"))
